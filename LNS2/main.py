...
if __name__ == '__main__':
    ...
    parser.add_argument('--instance', type=str, default=["../assets0/random-32-32-10.map"],
                        help='The name of the instance file(s)')
    parser.add_argument('--scens', nargs='+', default=["../assets0/random-32-32-10-random-1.scen"],
                        help='The name of the instance file(s)')
    ...
    parser.add_argument('--num_neighbour', type=int, default=9,
    ...
    for instance in scenario:
        ...
        result_file_name = "results/results_" + filename + "_" + args.solver + "_" + "agents" + str(
            args.num_agents) + "_" + "neighbours" + str(args.num_neighbour) + "_" + "limits" + str(
            args.time_limit) + "_" + "iter" + str(args.num_iteration) + ".csv"
        ...
        for file in files:
            ...
            for i in range(num_iteration):
                ...
                #     result_file.write(
                #         "iteration: {}, cost: {}, duration: {}, num_raplans: {}\n".format(i, cost, duration,
                #                                                                           num_replans))
            ...
            result_file.write(
                "Instance summary: num_iteration:{}, avg_cost: {}, avg_duration: {}, avg_replans: {}, std_duration: {}, success_ratio: {}%\n\n\n".format(
                    num_iteration, avg_cost, avg_duration, avg_replans, std_duration, success_ratio))
